...
const vipImg = libvips.symbols.vips_image_new_from_file(cstring(testFile), null)
console.log(`Try vips_image_new_from_file return ${vipImg} should be a VipsImage *`);
// const x = 10;
// const y = 10;
// const width = 1000;
// const height = 1000;
